              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-2 p-lg-3 text-black">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="pt-1 mb-4">
                      <button class="btn btn-dark btn-lg btn-block" type="submit" name="submit">Ajouter stagiaire</button>
                    </div>

                    <p class="mb-5 pb-lg-2" style="color: #393f81;"><a href="home.php" style="color: #393f81;">Voir la liste des stagiaires</a></p>
